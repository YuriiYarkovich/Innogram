...
**For React/Next.js projects:** Apply the performance patterns from `.codex/skills/react-best-practices/AGENTS.md`. Key priorities:
...
Read the full guidelines in `.codex/skills/react-best-practices/AGENTS.md` when working on React/Next.js code.
