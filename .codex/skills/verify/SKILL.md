...
Run the full Definition of Done checklist from `.codex/DOD.md` and produce a structured pass/fail report. This is the final gate before merge or PR creation.
