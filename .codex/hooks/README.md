# codex Code Hooks Documentation
...
**Tracking:** Uses `/tmp/codex-loop-detection/` (resets on reboot)

### Notification: Desktop Alert

**Purpose:** Desktop notification when codex needs user attention.
...
| Hook           | When it fires              |
| -------------- | -------------------------- |
| `SessionStart` | New codex Code session     |
| `Notification` | codex needs user attention |
| `Stop`         | codex finishes responding  |
| `PreToolUse`   | Before a tool executes     |
| `PostToolUse`  | After a tool executes      |

## Personal Hooks

Use `.codex/settings.local.json` for personal hooks that shouldn't be shared with the team.

## References

- [codex Code Hooks Documentation](https://docs.anthropic.com/en/docs/codex-code/hooks)
